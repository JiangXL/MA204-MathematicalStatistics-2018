...
<\body>
  ...
  and <math|Z and Y> are indepented.<with|font-series|bold|2.7> Let
  <math|x<rsub|1>,x<rsub|2>> be a random sample form the
  <math|N<around*|(|o,\<sigma\><rsup|2>|)>> population.
  ...
  and <math|X<rsub|d>=max<around*|{|X<rsub|1>,\<ldots\>,X<rsub|n>|}>>.
